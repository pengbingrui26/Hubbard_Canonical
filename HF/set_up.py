...
def init_fn(model):
    ...
    def _evolve(psi0, spin, sigmas, params):
        ...
        MFmatr = model.nspin_up() * delta1 + model.nspin_down() * delta2
    ...
    def make_eloc(psi0, sigmas_long, params):
        # sigmas_long has shape (nlayer, model.L*2)
        Eloc_real, Eloc_imag = make_Eloc(psi0, sigmas_long, params)
        Eloc = Eloc_real + Eloc_imag * I

        W_real, W_imag = make_W(psi0, sigmas_long, params)
        W = W_real + W_imag * I
